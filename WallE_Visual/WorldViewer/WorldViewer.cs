    ...
    public partial class WorldViewer : UserControl
    {
        ...
        public float SizePiece
        {
            ...
            set
            {
                if ( value >= 64 )
                    ...
                    MessageBox.Show("Не может быть меньше 64 px.", "Неверный размер.", MessageBoxButtons.OK,MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void LoadImages( )
        {
            ...
            foreach ( var wObjects in World.Where(c => c is WallEObjects) )
                ...
                {
                    MessageBox.Show("Нет изображения объекта: " + wObjects.ToString( ), "Ошибка изображения", MessageBoxButtons.OK,MessageBoxIcon.Error);
                }
        }
