...
namespace WallE_Visual
{
    public partial class SettingsWorldForm : Form
    {
        ...
        private void Simulate( )
        {
            ...
            {
                MessageBox.Show("Нет программируемых объектов для моделирования.", "Информация",MessageBoxButtons.OK,MessageBoxIcon.Information);
                return;
            }
        ...
        {
            if ( MessageBox.Show("Вы хотите перезагрузить мир? \nЕсли вы перезапустите его, вы потеряете все подпрограммы, которые вы не экспортировали.", "Сейчас возможна перезагрузка",MessageBoxButtons.YesNo,MessageBoxIcon.Warning) == DialogResult.Yes )
